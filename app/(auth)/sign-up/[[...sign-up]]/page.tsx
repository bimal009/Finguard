...
export default function Page() {
    return (
        <div className="min-h-screen w-full bg-gradient-to-br from-blue-600 to-blue-950 flex flex-col items-center justify-center p-4">
            ...
            <div className="  backdrop-blur-lg rounded-2xl  p-8 w-full max-w-md flex flex-col justify-center items-center">
                ...
                <div className="mb-6">
                    <div className="text-center">
                        ...
                        <p className="text-white text-sm mb-6">Your personal financial security assistant</p>
                    </div>
                    <div className="w-full  backdrop-blur-md flex justify-center items-center  rounded-xl text-center ">
                        ...
                        <ClerkLoading >
                            <Loader2 size={100} className='animate-spin text-white  text-center text-6xl' />
                        </ClerkLoading>
                    </div>
                </div>
                ...
                <div className="mt-8 flex items-center justify-center space-x-2 text-white text-xs">
